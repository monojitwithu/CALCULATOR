...
const calculator =
  new Calculator(); /*this calculator Object created from Calculator Class and has thouse atributes */
...
const updateSecoundarydisplay = () => {
  ...
  while (newNumArr.length !== 0) {
    ...
    innerHTML += `${num}<span class="operand">${
      signObject[operation] ? signObject[operation] : ""
    }</span>`;
  }
